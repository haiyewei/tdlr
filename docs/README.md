...
Use the language-specific directories as the primary documentation set:

- English: [docs/en/command-list.md](./en/command-list.md)
- 简体中文: [docs/zh-CN/command-list.md](./zh-CN/command-list.md)
